...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/dotnet.ps1 user-secrets set "AiProviders:Gemini:Model" "gemini-3.1-pro-preview" --project src/WebWritingTool.Web
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/dotnet.ps1 ef database update --project src/WebWritingTool.Infrastructure --startup-project src/WebWritingTool.Web
```
...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/dotnet.ps1 ef --version
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/dotnet.ps1 ef migrations add <MigrationName> --project src/WebWritingTool.Infrastructure --startup-project src/WebWritingTool.Web
```
