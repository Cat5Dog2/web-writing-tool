...
- MVPで採用するAIモデルはGoogle Gemini 3.7 Flashとする。
- テキスト生成モデルは将来複数選択できる設計とし、MVPの既定モデルはGoogle Gemini 3.7 Flashとする。Google Gemini 3.6 FlashとGoogle Gemini 3.5 Flashも選択可能なモデルとして残す。
...
- Gemini 3.7 FlashのAPIモデルIDは`gemini-3.7-flash`、Gemini 3.6 FlashのAPIモデルIDは`gemini-3.6-flash`、Gemini 3.5 FlashのAPIモデルIDは`gemini-3.5-flash`とする。
- Gemini 3.7 Flash、Gemini 3.6 Flash、Gemini 3.5 Flashの利用可能リージョンはJapanとする。
